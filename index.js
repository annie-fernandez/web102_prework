...
function filterUnfundedOnly() {
  ...
  // filter games that have not met their goal
...
const firstWordMostFunded = mostFunded.name.split(' ')[0];
const firstWordSecondMostFunded = secondMostFunded.name.split(' ')[0];
